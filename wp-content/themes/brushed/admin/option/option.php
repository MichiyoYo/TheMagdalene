...
return array(
    'title' => __('Brushed Theme Options', 'brushed'),
    'logo' => '',
    'menus' => array(
	    array(
		    'title' => __('General Settings', 'brushed'),
		    'name' => 'general',
		    ...
		    'controls' => array(
					    ...
					    array(
						    'type' => 'upload',
						    'name' => 'favicon',
						    'label' => __('Upload Favicon', 'brushed'),
						    'description' => __('.png or .ico image', 'brushed'),
						    'default' => '',
					    ),
					    array(
						    'type' => 'color',
						    'name' => 'primary_color',
						    'label' => __('Primary Body Color', 'brushed'),
						    'description' => __('Choose the color and opacity!', 'brushed'),
						    'default' => '',
						    'format' => 'rgba',
					    ),
					    array(
						    ...
						    'label' => __('Secondary Body Color', 'brushed'),
						    'description' => __('Choose the color and opacity!', 'brushed'),
						    'default' => '',
						    'format' => 'rgba',
					    ),
					    array(
						    'type' => 'color',
						    'name' => 'hover_color',
						    'label' => __('Color on Hover', 'brushed'),
						    'description' => __('Choose the color and opacity!', 'brushed'),
						    'default' => '',
						    'format' => 'rgba',
					    ),
					    array(
						    ...
						    'label' => __('Preloader Background Color', 'brushed'),
						    'description' => __('', 'brushed'),
						    'default' => '#98ed28',
					    ),
					    array(
						    ...
						    'label' => __('Circle Preloader', 'brushed'),
					    ...
					    array(
						    'type' => 'toggle',
						    'name' => 'to_top',
						    'label' => __('To Top Button', 'brushed'),
						    'description' => __('', 'brushed'),
						    'default' => '1',
					    ),
					    array(
						    'type' => 'toggle',
						    'name' => 'smooth',
						    'label' => __('Smooth Scrolling Effect', 'brushed'),
						    'description' => __('', 'brushed'),
						    'default' => '1',
					    ),
					    array(
	    ...
	    array(
		    'title' => __('Slider Options', 'brushed'),
		    'name' => 'slider',
	    ...
	    array(
		    'title' => __('Typography Options', 'brushed'),
		    'name' => 'typography',
	    ...
	    array(
		    'title' => __('Header Options', 'brushed'),
		    'name' => 'header',
	    ...
	    array(
		    'title' => __('Portfolio Options', 'brushed'),
		    'name' => 'portfolio',
	    ...
	    array(
		    'title' => __('Contact Options', 'brushed'),
		    'name' => 'contact',

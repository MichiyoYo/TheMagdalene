...
?>
<footer>
	<p style="margin-bottom: -20px;">Powered by <a  rel="nofollow" target="_blank" href="http://premiumwpstore.com/">Premium WordPress Themes</a> </p>
...
if (vp_option('vpt_option.to_top')){
	echo "<a id='back-to-top' href='#'><i class='font-icon-arrow-simple-up'></i>
	</a>";}
?>
...
<?php
 ...
 echo "header #logo a {
	background: url(".vp_option('vpt_option.logo').") no-repeat;}
	header #logo {

...
{
	$fonts   = wp_remote_fopen(get_template_directory_uri() . '/framework/data/gwf.json');
...
function vp_get_fontawesome_icons()
{
	...
	if( false === ( $icons  = get_transient( 'vp_fontawesome_icons' ) ) )
	{
		...
		$subject = wp_remote_fopen(get_template_directory_uri() . '/public/css/vendor/font-awesome.min.css');
